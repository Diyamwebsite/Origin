    ...
    <div class="panel-heading active" role="tab" id="headingOne">
      <h4 class="panel-title">
        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          SPM Program Assessment &amp; Planning
        </a>
      </h4>
    </div>
    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
      <div class="panel-body">
        Offering a complete end-to-end analysis for defining and planning a future state solution to support your SPM. We'll work with you to assess your current state, determine the target future state, and develop the roadmap to get there. This includes optimization, justification, and solution recommendations.
      </div>
    </div>
  </div>
  <div class="panel panel-default">
